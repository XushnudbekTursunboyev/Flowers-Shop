package uz.xushnudbek.flowersshop.ui.fragments.shopping.cart
...
import uz.xushnudbek.flowersshop.databinding.FragmentCartBinding
import uz.xushnudbek.flowersshop.model.CartProductsList
import uz.xushnudbek.flowersshop.resource.Resource
import uz.xushnudbek.flowersshop.util.Constants.Companion.SELECT_ADDRESS_FLAG
...
class CartFragment : Fragment() {
    ...
    private fun onCheckoutClick() {
        binding.btnCheckout.setOnClickListener {
            ...
            bundle.putSerializable("products", cartProducts)
                ...
                is Resource.Success -> {
                    binding.apply {
                        ...
                        findNavController().navigate(
                            R.id.action_cartFragment_to_productPreviewFragment,
                            bundle
                        )
